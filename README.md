...
<img src="README assets/1-1.jpg" width="500"></img>

        4. Case Scientific mode:
            4.1. Diplay the Scientific Menu (Trigonometric, Exponent, Rounding):
<img src="README assets/1-2.jpg" width="500"></img>
...
<img src="README assets/1-2-1.jpg" width="500"></img>
...
<img src="README assets/1-2-2.jpg" width="500"></img>
...
<img src="README assets/1-2-3.jpg" width="500"></img>

        5. Case any wrong choice, make the user tries again.
<img src="README assets/wrong-choice.jpg" width="500"></img>

        6. Case result is displayed ask user wether to continue or exit.
        7. Case continue, Go to step 1.
<img src="README assets/continue.jpg" width="500"></img>

        8. Case exit, end the program.
<img src="README assets/end.jpg" width="500"></img>
